...
class Smarty_Internal_Compile_Foreach extends Smarty_Internal_Compile_Private_ForeachSection
{
     ...
     * @var array
     */
    public $nameProperties = array('first', 'last', 'home', 'iteration', 'show', 'total');
     ...
     * @var array
     */
    public $itemProperties = array('first', 'last', 'home', 'iteration', 'show', 'total', 'key');
    ...
    public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler, $parameter)
    {
        ...
        if (isset($itemAttr[ 'home' ])) {
            $output .= "{$itemVar}->home = -1;\n";
        }
        ...
        if (isset($itemAttr[ 'first' ])) {
            $output .= "{$itemVar}->first = !{$itemVar}->home;\n";
        }
        if (isset($itemAttr[ 'last' ])) {
        ...
        if ($this->isNamed) {
            ...
            if (isset($namedAttr[ 'home' ])) {
                $output .= "{$foreachVar}->value['home']++;\n";
            }
            if (isset($namedAttr[ 'first' ])) {
                $output .= "{$foreachVar}->value['first'] = !{$foreachVar}->value['home'];\n";
            }
            if (isset($namedAttr[ 'last' ])) {
